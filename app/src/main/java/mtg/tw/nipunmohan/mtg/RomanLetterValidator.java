...
public class RomanLetterValidator {

    private RomanLetterValidator(){
    ...
    public static int validateRoman(String romanNumber) throws Exception{
        ...
        for(int i = 0; i<charArray.length; i++){
            ...
            int currentRomanCharNumericValue = RomanLetters.Roman.valueOf(String.valueOf(currentChar)).getValue();

            if(previousChar != ' '){
                previousCharacterOrdinal = RomanLetters.Roman.valueOf(String.valueOf(previousChar)).ordinal();
            }
            currentCharacterOrdinal = RomanLetters.Roman.valueOf(String.valueOf(currentChar)).ordinal();
            ...
            if(currentChar == previousChar && ++characterRepeatCount < 4 && THREE_TIMES_REPEATED_CHARACTERS.contains(currentChar)){
                ...
                int previousRomanCharNumericValue = RomanLetters.Roman.valueOf(String.valueOf(previousChar)).getValue();
